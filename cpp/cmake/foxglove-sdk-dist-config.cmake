...
set(FOXGLOVE_SDK_CPP_WEBTRANSPORT_SOURCES ${FOXGLOVE_CPP_WEBTRANSPORT_SOURCES})
list(TRANSFORM FOXGLOVE_SDK_CPP_WEBTRANSPORT_SOURCES PREPEND "${_foxglove_src_dir}/")
...
function(foxglove_sdk_add_cpp_library name)
  cmake_parse_arguments(_arg "" "TYPE;REMOTE_ACCESS;WEBTRANSPORT" "" ${ARGN})
  if(NOT _arg_TYPE)
  ...
  if(NOT _arg_WEBTRANSPORT)
    set(_arg_WEBTRANSPORT OFF)
  endif()
  ...
  if(_arg_WEBTRANSPORT)
    list(APPEND _srcs "${FOXGLOVE_SDK_CPP_WEBTRANSPORT_SOURCES}")
  endif()
  ...
  if(_arg_WEBTRANSPORT)
    target_compile_definitions(${name} PUBLIC FOXGLOVE_WEBTRANSPORT)
  endif()
endfunction()
