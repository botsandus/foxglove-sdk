...
struct JointState {
  ...
  /// @brief Joint positions in radians (revolute) or meters (prismatic)
  std::vector<double> position;

  /// @brief Joint velocities in rad/s (revolute) or m/s (prismatic)
  std::vector<double> velocity;

  /// @brief Joint efforts in Nm (revolute) or N (prismatic)
